...
angular.module('famousAngularStarter')
  .controller('ServiceCtrl', function ($scope, $famous, $state) {
    ...
    $scope.serviceRotateAn = new Transitionable(0);
    $scope.serviceRotateAn.set(-Math.PI/4, {'duration': 200, 'curve': Easing.inOut}, function() {
        $scope.serviceRotateAn.set(Math.PI/4, {'duration': 200, 'curve': Easing.inOut}, function() {
            $scope.serviceRotateAn.set(0, {'duration': 300, 'curve': Easing.inOut});
        });
    });
